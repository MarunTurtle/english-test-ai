  ...
  return (
    <div className="space-y-4">
      ...
      {questions.map((question, idx) => (
        <div
          key={question.id}
          className={`bg-white border-l-8 rounded-xl overflow-hidden shadow-sm flex ${
        ...
        >
          ...
          <div className="w-64 bg-slate-50 border-l border-slate-100 p-6 flex flex-col gap-2 justify-center">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-200 transition-colors"
            >
              <FiRefreshCw className="w-4 h-4" /> Regenerate
            </button>
            <button
              onClick={() => handleEditClick(question)}
              className="w-full flex items-center justify-center gap-2 py-2 text-sm font-medium text-slate-600 bg-white hover:bg-slate-100 rounded-lg border border-slate-200 transition-colors"
            >
